...
migzapp.get("/getprofileDetails/:id",verifyJWT,(req, res, next) => {
...
migzapp.put("/updateprofileDetails/:id",(req, res, next) => {
...
let fullname = req.body.fullname;
      ...
      User.findById(req.params.id)
        .then((user) => {
          ...
          ///CHECKING THE CHANGES AND migzappLY
          if(bio=="" ){
            bio+=user.bio
...
migzapp.put("/updatesocialLinks/:id",(req, res, next) => {
let fb = req.body.fb
...
migzapp.put("/updateExperience/:id",(req, res, next) => {
